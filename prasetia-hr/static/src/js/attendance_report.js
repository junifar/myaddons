odoo.define('attendance_report', function(require){
    'use strict';

    var kanban_widgets = require('web_kanban.widgets');

    var AttendanceReportGraph = kanban_widgets.AbstractField.extend({
        start: function () {
    ...
    kanban_widgets.registry.add('dashboard_graph', AttendanceReportGraph);
});