...
class LaporanBarangBukti(models.AbstractModel):
	_name = 'report.tilang.laporan_barang_bukti'
		...
		query = """
				SELECT
					...
					count("public".court_kejaksaan_negeri."name") AS jumlah_perkara,
				 	"count"("public".court_case.barang_bukti_type) as count_barang_bukti,
					count(CASE WHEN "public".court_case.barang_bukti_type IS NOT NULL AND "public".court_case.status_pengembalian_barang_bukti THEN 1 ELSE NULL END) as count_barang_bukti_kembali,
				count(CASE WHEN "public".court_case.barang_bukti_type IS NOT NULL AND NOT "public".court_case.status_pengembalian_barang_bukti THEN 1 ELSE NULL END) as count_barang_bukti_tersisa
				FROM
					"public".court_case
	...
	def render_html(self,data):
		...
		return self.env['report'].render('tilang.laporan_barang_bukti', docargs)