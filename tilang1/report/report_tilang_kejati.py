...
class ReportTilangKejati(models.AbstractModel):
	_name = 'report.tilang.report_tilang_kejati'
	...
	def render_html(self,data):
		...
		return self.env['report'].render('tilang.report_tilang_kejati', docargs)